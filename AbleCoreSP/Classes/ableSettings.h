...
class ABLECORESP_API USPAbleSettings : public UObject
{
	GENERATED_BODY()

public:
	USPAbleSettings(const FObjectInitializer& ObjectInitializer);
	virtual ~USPAbleSettings();
	...
	void SetLogVerbose(bool bNewVal) { m_LogVerbose = bNewVal; }
